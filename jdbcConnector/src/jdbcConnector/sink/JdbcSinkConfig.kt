package jdbcConnector.sink.config
...
class JdbcSinkConfig(props: Map<String, String>) : AbstractConfig(CONFIG_DEF, props) {
    ...
    companion object {
        ...
        val CONFIG_DEF: ConfigDef = ConfigDef()
            ...
            .define(FLUSH_SIZE, Type.INT, 1000, Importance.MEDIUM, "Flush threshold (records)")
            .define(FLUSH_INTERVAL_MS, Type.LONG, 30000L, Importance.MEDIUM, "Flush threshold (time)")
